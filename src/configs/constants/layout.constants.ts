...
export const PLAYER_WIDTH_SCALE_RATIO = 30 / 320; // float between 0 and 1
export const PLAYER_OFFSET_Y = -100;
export const PLAYER_GROUP_GAP_X = 20; // each player x gap
export const PLAYER_HEALTH_BAR_OFFSET_Y = 10;

export const ENEMY_WIDTH_SCALE_RATIO = 80 / 320; // float between 0 and 1
