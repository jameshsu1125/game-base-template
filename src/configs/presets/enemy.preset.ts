...
export const enemyEntityConfig: TEnemyPresetConfig[] = [
  ...
  { time: 14300, data: { x: 75, type: "follow", blood: smallEnemy } },
  { time: 15300, data: { x: 45, type: "follow", blood: smallEnemy } },
  { time: 16000, data: { x: 25, type: "follow", blood: smallEnemy } },
  { time: 16000, data: { x: 75, type: "follow", blood: smallEnemy } },
  { time: 17500, data: { x: 55, type: "follow", blood: smallEnemy } },
  { time: 18300, data: { x: 50, type: "follow", blood: smallEnemy } },
  { time: 19900, data: { x: 20, type: "follow", blood: smallEnemy } },
  ...
  { time: 23900, data: { x: 70, type: "follow", blood: smallEnemy } },
  { time: 24800, data: { x: 75, type: "follow", blood: smallEnemy } },
  ...
  { time: 28000, data: { x: 60, type: "follow", blood: smallEnemy } },
